...
<?php elseif( route(3) == "edit" && route(3)): ?>
<div class="col-md-10">
    ...
    <div class="panel-body">
         ...
         <form action="<?php echo base_url('admin/settings/subject/edit/'.route(4)) ?>" method="post" enctype="multipart/form-data">
...
<select class="form-control" name="auto_reply">
    ...
    elseif($post["auto_reply"] == 1){echo'selected'; }?>>Aktif</option>
           ...
           <p>Bu konu başlığı altında yeni bir destek talebi oluşturulduğunda otomatik gönderilecek cevap.</p> 
            ...
            <a href="<?php echo base_url('admin/settings/subject/delete/'.$post["subject_id"]) ?>" class="btn btn-link pull-right deactivate-integration-btn">
                                Sil
                            </a>
