<?= view('admin/static/header'); ?>
 ...
 <div class="container-fluid">
   <div class="row">
     ...
     <li class="active"><a href="<?= base_url()?>/admin/guard_logs">Koruma Logları <?php if(countRow(['table'=>'guard_log'])): ?>
              ...
              <h4>Koruma Logları</h4>
               <div class="table-responsive">
                  <table class="table">
                     ...
                     <form id="changebulkForm" action="<?php echo base_url("admin/guard_logs/multi-action") ?>" method="post">
                       <tbody>
                         <?php if( !$logs ): ?>
                           <tr>
                         ...
                         <?php foreach($logs as $log): ?>
                          <tr>
                             ...
                             <td> <a href="<?php echo base_url("admin/guard_logs/delete/".$log["id"]) ?>" style="font-size:12px">Sil</a> </td>
                          </tr>
                        <?php endforeach; ?>
                       </tbody>
