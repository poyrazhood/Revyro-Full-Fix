                    ...
                    <div class="tab-pane fade show active" id="ex1-tabs-1" role="tabpanel" aria-labelledby="ex1-tab-1">
                        <div class="col-md-12">
                            <form class="needs-validation form" action="<?php if (in_array($serviceInfo["service_package"], $abonelik)) {
                                                                            ...
                                                                            echo base_url("admin/services/edit-service/" . $serviceInfo["service_id"]);
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <textarea class="form-control" id="tinymce" name="aciklama"><?= $serviceInfo['service_description'] ?></textarea>
                                    </div>
                                    <!-- **************ACIKLAMA SONU**************** -->
                                    <hr class="mb-0">
                                    <!-- **************MOD BASLANGIC**************** -->
