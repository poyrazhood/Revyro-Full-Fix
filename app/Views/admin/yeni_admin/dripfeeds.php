...
<div class="container-fluid px-sm-5">
    <div class="row">
        ...
        <div class="col-md-12 collapse ms-auto mb-3" id="search">
            <form class="form-inline" action="<?=base_url("admin/dripfeeds")?>" method="get">
                   ...
                   <div class="dropdown pull-right">
                    <button class="btn btn-secondary dropdown-toggle " type="button"
                     ...
                     <ul class="dropdown-menu">
                           ...
                           <li><a href="#" data-bs-toggle="modal" data-bs-target="#confirmChange" data-href="<?=site_url("admin/dripfeeds/dripfeed_canceled/".$order["order_id"])?>">Canceled</a></li>
                           <li><a href="#" data-bs-toggle="modal" data-bs-target="#confirmChange" data-href="<?=site_url("admin/dripfeeds/dripfeed_completed/".$order["order_id"])?>">Completed</a></li>
                           <li><a href="#" data-bs-toggle="modal" data-bs-target="#confirmChange" data-href="<?=site_url("admin/dripfeeds/dripfeed_canceledbalance/".$order["order_id"])?>">Canceled and Check-in</a></li>
