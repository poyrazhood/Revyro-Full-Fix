...
<div class="col-md-8">
  <div class="settings-header__table">
    <a href="<?= base_url("admin/appearance/language/new") ?>"  class="btn btn-default m-b">Yeni Dil Ekle</a>
  </div>
   <table class="table report-table" style="border:1px solid #ddd">
      ...
      <tbody>
       ...
       <td>
             <div class="tt" style="font-size: 1.5em;">    <a href="<?php echo base_url('admin/appearance/language/?lang-id='.$language["language_code"].'&lang-type=1') ?>"><span class="tt-icon tt-switch-color" style="color: rgb(0, 102, 255);"><i class="tt-switch-on"></i></span></a></div></td>
             <?php endif; ?>
    
                 
               <?php if( $language["language_type"] == 1 ): ?>
                  <td><div class="tt" style="font-size: 1.5em;">   <a href="<?php echo base_url('admin/appearance/language/?lang-id='.$language["language_code"].'&lang-type=2') ?>"><span class="tt-icon tt-switch-color" style="color: rgb(153, 153, 153);"><i class="tt-switch-off"></i></span></a></div></td>
                  <?php endif; ?>
 
            <td class="text-right col-md-1">
              <div class="dropdown pull-right">
             
                <a class="btn btn-default btn-xs pull-right" href="<?php echo base_url('admin/appearance/language/'.$language["language_code"]) ?>">
                                Düzenle                            </a>
              </div>
            </td>
         </tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    ...
                                    <button type="submit" id="edit-language-btn" class="btn btn-primary" name="save-button">Güncelle</button>   
                                      <a href="<?= base_url("admin/appearance/language") ?>" class="btn btn-default">Geri</a></div>
                            </div>
                    </div>
         </form>
...
<div class="col-md-12">
   <div class="panel panel-default">
       <div class="language-editor__header">
                    <div class="row"><div class="language-editor__header-title">
                      ...
                      <a class="btn btn-xs btn-default" href="<?php echo base_url('admin/appearance/language/?lang-id='.$language["language_code"].'&lang-default=1') ?>" id="default-language">
  ...
  <input class="form-control" placeholder="Kelime ara..."  id="myInput" onkeyup="myFunction()" type="text" value="">                                </div>
		 ...
		 <div class="language-editor__container" style="max-height: 680px;">
         <form action="<?php echo base_url('admin/appearance/language/'.route(4)) ?>" method="post" enctype="multipart/form-data">
           <div class="form-group">
              <label class="control-label">Dil Adı</label>
